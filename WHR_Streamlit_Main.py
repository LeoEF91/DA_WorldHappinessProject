...
""")
    ...
    df1['Predicted Ladder score'] = predictions
    
    top_5_happiest = df1.nlargest(5, 'Predicted Ladder score')[['Country name', 'Predicted Ladder score']]
    bottom_5_unhappiest = df1.nsmallest(5, 'Predicted Ladder score')[['Country name', 'Predicted Ladder score']]
