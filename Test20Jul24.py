...
st.sidebar.markdown("""
    ...
    <a href='https://www.linkedin.com/in/leonieefickinger' style='color:blue;'>
...
if page == pages[0]: 
    ...
    st.write("")
    st.image(r"C:\Users\HP\Desktop\Presentation\WHR1.jpg", caption='', use_column_width=True)
...
""")
    ...
    st.image(r"C:\Users\HP\Desktop\Presentation\Merged_Dataset.jpg", caption='Merged data set 2005-2021 with common columns', use_column_width=True)
